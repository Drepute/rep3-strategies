...
export default class BlockExplorer {
    ...
    public checkedBlocks :object
    public savedBlocks:object
    public requests:number
    public latestBlock?:object|any
    ...
    async getDate(date, after = true, refresh = false) {
        ...
        const predictedBlock:object = await this.getBlockWrapper(Math.ceil(date.diff(moment.unix(this.firstBlock.timestamp), 'seconds') / this.blockTime));
